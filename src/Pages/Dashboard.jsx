      ...
      <div className="w-[100%]">
        <div className="flex border-b border-[#D8D4D4] pt-3">
          ...
          <div className="flex ml-[65rem]">
            <img src="/src/img/user-solid.svg" alt="" className="border-2 border-[#909090] rounded-[100%] w-[2rem] h-[2rem]"/>
            <p className="pl-1 font-semibold font-raleway text-[#787878] mt-1">User</p>
            <img src="/src/img/fleche_bas.svg" alt="" className="w-[10px] relative bottom-5 left-2"/>
          </div>
          
        </div>
{/* partie bannière */}
        <div className= "h-40 w-[73%] ml-[10.3rem] mt-12 rounded-lg bg-center bg-cover" style={{
        backgroundImage:
          "url('./src/img/istockphoto-1322302356-1024x1024 1.jpg')",
      }}>
          <div className="inset-0 bg-black opacity-60 h-40 w-[100%] rounded-lg"></div>
          <h1 className="font-bold text-white font-raleway text-[3.5rem] relative bottom-[9rem] left-14">Welcome to Minetrack</h1>
        </div>
